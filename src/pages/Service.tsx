...
const data: Record<string, ServiceData> = {
  ...
  "headlight-restoration": {
    ...
    faqs: [
      { q: "How long does headlight restoration take?", a: "Most restorations are completed within a few hours depending on the level of oxidation and damage." },
      { q: "How long do restored headlights stay clear?", a: "With our UV protection treatment, results typically last 1–2 years depending on sun exposure and care." },
      { q: "Is restoration cheaper than replacing headlights?", a: "Yes — professional restoration is a fraction of the cost of replacing OEM headlight assemblies." },
      { q: "Will restoration fix deep cracks?", a: "Restoration corrects oxidation, yellowing and surface scratches. Deep internal cracks usually require replacement." },
      { q: "Do you restore both plastic and glass headlights?", a: "Yes, our process is safe for plastic polycarbonate lenses and works with most modern headlight assemblies." },
    ],
  },
};
