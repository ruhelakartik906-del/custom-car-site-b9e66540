...
const data: Record<string, ServiceData> = {
  ...
  "exterior-detailing": {
    ...
    faqs: [
      { q: "How is exterior detailing different from a regular car wash?", a: "A regular wash only removes loose dirt. Exterior detailing involves decontamination, polishing and protection — restoring gloss, paint smoothness and long-term protection." },
      { q: "How often should I get exterior detailing?", a: "For best results, every 3–6 months depending on your driving conditions, parking environment and existing paint protection." },
      { q: "Will exterior detailing remove scratches?", a: "Light swirl marks and surface defects can be reduced or removed during polishing. Deeper scratches may need dedicated paint correction." },
      { q: "Should I add ceramic coating after exterior detailing?", a: "Yes — ceramic coating locks in the gloss and protects the freshly detailed paint for years of easier maintenance." },
    ],
  },
};
