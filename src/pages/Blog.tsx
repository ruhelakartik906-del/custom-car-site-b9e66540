...
const BrandSection = ({
  ...
  <div className="mt-14 border-t border-border pt-12">
    ...
    <div className="mt-8">
      <h3 className="font-display text-2xl flex items-center gap-3"><Sparkles className="h-5 w-5 text-gold" /> {features.heading}</h3>
      <ul className="mt-5 grid sm:grid-cols-2 gap-3">
        {features.items.map((f) => <Bullet key={f}>{f}</Bullet>)}
      </ul>
    </div>

    {products && (
      <div className="mt-10">
        <h3 className="font-display text-2xl flex items-center gap-3"><Gem className="h-5 w-5 text-gold" /> Product Range</h3>
        <div className="mt-5 grid md:grid-cols-2 gap-4">
          {products.map((p) => (
            <div key={p.name} className="bg-card border border-border p-5 rounded-sm">
              <h4 className="font-display text-lg text-gold">{p.name}</h4>
    ...
    <div className="mt-10">
      <h3 className="font-display text-2xl flex items-center gap-3"><Car className="h-5 w-5 text-gold" /> Applications</h3>
      <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 gap-3">
        {applications.map((a) => (
          <div key={a} className="flex items-center gap-2 bg-card border border-border p-3 rounded-sm">
            <CheckCircle2 className="h-4 w-4 text-gold shrink-0" />
    ...
    <div className="mt-10">
      <h3 className="font-display text-2xl flex items-center gap-3"><ShieldCheck className="h-5 w-5 text-gold" /> Why Buy from CLNHYGEN</h3>
      <ul className="mt-5 grid sm:grid-cols-2 gap-3">
    ...
    <div className="mt-8 bg-card border border-border p-6 rounded-sm">
      <p className="text-muted-foreground leading-relaxed">{closing}</p>
    </div>
  </div>
);

const BrandDistributorArticle = () => (
  <>
    <div className="aspect-[16/8] overflow-hidden rounded-sm mb-10">
      <img src={ppfHero} alt="CLNHYGEN premium brand distributor in India" className="w-full h-full object-cover" />
    </div>

    <p className="text-lg text-muted-foreground leading-relaxed">
      CLNHYGEN is India's trusted distributor for the world's most respected automotive protection brands — <strong className="text-foreground">STEK Paint Protection Film</strong>, <strong className="text-foreground">CARPRO Ceramic Coating</strong>, <strong className="text-foreground">AUTOKROM Automotive Protection</strong>, and <strong className="text-foreground">Saint-Gobain Automotive Solutions</strong>. This complete guide covers every premium brand we supply across India to detailing studios, PPF installers, dealerships, and luxury car owners.
    </p>

    <BrandSection
      title="STEK Paint Protection Film (PPF) Distributor in India"
      intro={[
        "CLNHYGEN is a trusted distributor of STEK Paint Protection Film (PPF) in India, offering world-class vehicle protection solutions for detailing studios, PPF installers, automotive dealerships, and car enthusiasts. As a global leader in Paint Protection Film technology, STEK delivers superior protection, exceptional clarity, and industry-leading self-healing performance.",
        "Whether you own a luxury vehicle, sports car, SUV, or daily driver, STEK PPF helps preserve your vehicle's original paint while maintaining a showroom-quality finish. STEK PPF creates an invisible shield over your vehicle's paint, helping prevent damage caused by everyday driving conditions. Its advanced top-coat technology allows minor scratches and swirl marks to disappear with heat exposure.",
      ]}
      features={{
        heading: "Key Features of STEK PPF",
        items: [
      ...
      products={[
        { name: "STEK DYNOshield", desc: "One of the most trusted Paint Protection Films in the industry. Premium top-coated clear PPF designed to shield vehicle exteriors from rock chips, scratches, stains, and environmental damage with self-healing properties." },
        { name: "STEK DYNOmatte", desc: "Designed for matte-finish vehicles, DYNOmatte preserves the original satin appearance while providing advanced paint protection." },
        { name: "STEK Fashion Films", desc: "Enhance your vehicle's appearance with unique finishes and colors that combine style with protection." },
        { name: "STEK Windshield Protection Films", desc: "Protect vehicle windshields from chips, cracks, and road hazards with advanced STEK windshield protection." },
      ]}
      applications={["Luxury Cars", "Sports Cars", "SUVs", "Supercars", "Electric Vehicles", "Motorcycles", "Commercial Fleets", "Premium Collections"]}
      benefits={[
        "Genuine STEK Products",
        "Authorized Distribution Support",
        "Dealer & Installer Programs",
        "Competitive Pricing",
        "Nationwide Supply Network",
        "Technical Product Guidance",
        "Training & Installation Support",
        "Bulk Purchase Solutions",
      ]}
      closing="Looking for STEK PPF India, STEK Distributor India, Self-Healing Paint Protection Film, or Premium PPF for Cars? CLNHYGEN proudly supplies STEK Paint Protection Film across India, helping professionals deliver superior results and long-lasting vehicle protection."
    />

    <BrandSection
      title="CARPRO Ceramic Coating Products Distributor in India"
      intro={[
        "CLNHYGEN is a trusted distributor of CARPRO products in India, providing world-class ceramic coating, paint correction, and automotive detailing solutions for professional detailers, coating studios, dealerships, and car enthusiasts.",
        "Globally recognized for innovation and performance, CARPRO is a leader in ceramic coating technology, trusted by detailing professionals in more than 90 countries. CARPRO ceramic coatings create a durable protective layer over your vehicle's paint, defending against environmental contaminants, UV rays, bird droppings, water spots, and daily wear.",
      ]}
      features={{
        heading: "Key Benefits of CARPRO Products",
        items: [
          "Advanced Ceramic Coating Technology",
          "Long-Lasting Paint Protection",
          "Deep Gloss & Mirror-Like Shine",
          ...
          "Trusted Worldwide by Detailers",
        ],
      }}
      products={[
        { name: "CARPRO CQuartz Ceramic Coating", desc: "One of the most respected ceramic coating systems in the automotive industry — known for durability, gloss enhancement, and hydrophobic properties." },
        { name: "CARPRO Maintenance Products", desc: "Premium shampoos, quick detailers, cleaners, and maintenance products designed to extend coating performance on coated vehicles." },
        { name: "CARPRO Paint Correction System", desc: "Professional compounds, polishes, and surface preparation products that help achieve flawless paint correction before ceramic coating application." },
        { name: "CARPRO Interior & Exterior Care", desc: "Complete solutions for leather, plastic, vinyl, glass, wheels, and exterior surfaces ensuring comprehensive vehicle care." },
      ]}
      applications={["Ceramic Coating Studios", "Car Detailing Centers", "Luxury Vehicle Owners", "Automotive Dealerships", "PPF Installation Centers", "Car Care Professionals", "Auto Enthusiasts", "Fleet Protection Services"]}
      benefits={[
        "Genuine CARPRO Products",
        "Distributor Support Across India",
        "Competitive Dealer Pricing",
        "Bulk Supply Solutions",
        "Professional Product Training",
        "Technical Assistance",
        "Fast & Reliable Delivery",
        "Support for Detailing Businesses",
      ]}
      closing="If you are looking for premium ceramic coating products in India, CARPRO delivers the perfect combination of protection, durability, hydrophobic performance, and gloss enhancement. CLNHYGEN proudly supplies CARPRO products across India for superior detailing results."
    />

    <BrandSection
      title="AUTOKROM Automotive Protection Solutions in India"
      intro={[
        "CLNHYGEN proudly offers AUTOKROM automotive protection solutions designed to provide superior durability, enhanced vehicle appearance, and long-term preservation. Developed with advanced automotive protection technology, AUTOKROM products help protect vehicles from environmental damage, daily wear, and surface deterioration while maintaining a premium finish.",
        "Whether you own a luxury car, SUV, sports vehicle, or commercial fleet, AUTOKROM solutions are engineered to keep your vehicle protected and looking its best for years. By creating a durable protective barrier, AUTOKROM helps maintain the vehicle's original appearance while reducing long-term maintenance costs.",
      ]}
      features={{
        heading: "Key Benefits of AUTOKROM Products",
        items: [
          ...
          "Improved Surface Gloss & Finish",
          "Easy Vehicle Maintenance",
          "Protection Against Oxidation & Fading",
          "Professional-Grade Performance",
          "Suitable for Premium & Luxury Vehicles",
        ],
      }}
      applications={["Luxury Cars", "Sports Cars", "SUVs", "Premium Sedans", "Electric Vehicles", "Commercial Vehicles", "Automotive Dealerships", "Detailing Studios", "Vehicle Protection Centers"]}
      benefits={[
        "Genuine AUTOKROM Products",
        "Professional Technical Support",
        "Nationwide Supply Network",
        "Competitive Dealer Pricing",
        "Bulk Order Solutions",
        "Product Consultation & Guidance",
        "Support for Detailing Businesses",
        "Reliable Distribution Across India",
      ]}
      closing="Today's vehicles require advanced protection against environmental damage. AUTOKROM delivers innovative solutions designed to preserve paint quality, enhance durability, and maintain a showroom-like finish — backed by CLNHYGEN's trusted industry expertise."
    />

    <BrandSection
      title="Saint-Gobain Automotive Solutions in India"
      intro={[
        "CLNHYGEN proudly offers Saint-Gobain automotive solutions, backed by over 350 years of innovation in advanced materials and high-performance technologies. Globally recognized for excellence, Saint-Gobain delivers cutting-edge solutions that enhance vehicle durability, comfort, safety, and long-term protection.",
        "From automotive glazing technologies to advanced protection materials, Saint-Gobain products are trusted by leading vehicle manufacturers, automotive professionals, and industry experts worldwide. These solutions support vehicle surface protection, glass protection technologies, heat reduction, UV protection systems, enhanced cabin comfort, and improved safety & visibility.",
      ]}
      features={{
        heading: "Key Benefits of Saint-Gobain Automotive Solutions",
        items: [
          "Advanced Automotive Protection Technologies",
      ...
      applications={["Luxury Vehicles", "Premium SUVs", "Sports Cars", "Electric Vehicles", "Commercial Vehicles", "Automotive Dealerships", "Vehicle Protection Centers", "Detailing Studios", "Fleet Management"]}
      benefits={[
        "Genuine Saint-Gobain Solutions",
      ...
      closing="Saint-Gobain continues to lead the industry through research, innovation, and advanced engineering. Through CLNHYGEN, automotive professionals and vehicle owners across India can access world-class protection, durability, and performance."
    />

    <div className="mt-14 bg-card border border-border p-8 rounded-sm">
      <h3 className="font-display text-2xl">Partner with CLNHYGEN</h3>
      <p className="mt-4 text-muted-foreground leading-relaxed">
        CLNHYGEN is committed to bringing world-class automotive technologies to the Indian market. From STEK Paint Protection Film and CARPRO Ceramic Coating to AUTOKROM surface protection and Saint-Gobain advanced materials, we help detailing studios, PPF installers, and luxury vehicle owners achieve superior protection, durability, and performance.
      </p>
      <div className="mt-6 flex flex-wrap gap-4">
        <Link to="/contact" className="inline-flex items-center gap-2 bg-gold text-background px-7 py-3 rounded-sm font-medium hover:opacity-90 transition">
          Become a Dealer / Get a Quote <ArrowRight className="h-4 w-4" />
        </Link>
        <Link to="/products" className="inline-flex items-center gap-2 border border-border px-7 py-3 rounded-sm font-medium hover:border-gold transition">
